...
/*    public static void main(String[] args) {
        String token = "eyJhbGciOiJIUzUxMiJ9.eyJsb2dpbl91c2VyX2tleSI6IjUyMTY3ZTkwLTljOTEtNDhiMy04ZTVmLThjY2IzODQ5YWIzZCJ9.l_ChenzycVXPhpNACpp6FIPSzFiPZw_PIXscRXih2cCWMisfsDp9vndkn7dUsN6-Bu-qzzagrxvtmTVs95AnEw";
     ...
     * @return 用户信息
     */
    public BigoUser getBigoUser(HttpServletRequest request)
    {
        // 获取请求携带的令牌
        String token = getToken(request);
        if (StringUtils.isNotEmpty(token))
        {
            ...
            LoginUser user = redisCache.getCacheObject(userKey);
            if(user != null) {
                return user.getBigoUser();
            }
        }
        throw new CustomException("user_not_logged_in", HttpStatus.UNAUTHORIZED);
    }
