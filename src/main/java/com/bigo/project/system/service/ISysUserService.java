...
public interface ISysUserService
{
     ...
     * @return
     */
     List<Long> listCustomerService();

    List<UserSumVo> getParentUser(Map parms);

    List<UserSumVo> getChildrenList(Map parms);

    int updateGoogleAuthStatus(SysUser sysUser);

    List<UserChildrenVo> topUserList(WalletEntity entity);

    List<UserChildrenVo> lowLevelUserList(WalletEntity entity);
}
